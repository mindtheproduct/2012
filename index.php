  ...
  <head>
    ...
    <!--[if IE]>
	  ...
	  <!-- stylesheets -->
		...
		<!-- typekit -->
		<script type="text/javascript" src="http://use.typekit.com/mus3wjm.js"></script>
	...
	<body>
		...
		<div id="global-container">
			...
			<div id="start-page">
				...
				<div class="content">
					<ul class="main-nav">
						<li><a class="selected scroll" href="#home">Home</a></li>
			...
			<div id="speakers">
				...
				<div class="content">
					<ul class="main-nav">
						...
						<li><a class="selected scroll" href="#speakers">Speakers</a></li>
						<li><a href="#schedule" class="scroll">Schedule</a></li>
						<li><a href="#location" class="scroll">Location</a></li>
						<li><a href="#the-team" class="scroll">The Team</a></li>
					</ul><!-- end main-nav -->
			...
			<div id="schedule">
				...
				<div class="content">
					<ul class="main-nav">
						<li><a href="#home" class="scroll">Home</a></li>
						<li><a href="#speakers" class="scroll">Speakers</a></li>
						<li><a class="selected scroll" href="#schedule">Schedule</a></li>
						<li><a href="#location" class="scroll">Location</a></li>
						<li><a href="#the-team" class="scroll">The Team</a></li>
					</ul><!-- end main-nav -->
            ...
            <a class="download" href="http://conference.mindtheproduct.com/sponsorpack.pdf" title"MindtheProduct Conference Sponsor Pack">Download</a>
				...
				<div class="sponsors-circle">
					...
					<div class="sponsors-large">
						...
						<div class="sponsor-medium right"><img src="images/skyscanner.png" width="142" height="50" alt="Skyscanner" /></div>
						<div class="sponsor-medium"><img src="images/pearson.png" width="142" height="50" alt="Pearson" /></div>
						<div class="sponsor-medium right"><img src="images/skype.png" width="142" height="50" alt="Skype" /></div>
						<div class="sponsor-medium space right"><img src="images/product-focus.png" width="142" height="50" alt="Product Focus" /></div>
						<div class="sponsor-medium space"><img src="images/yammer.png" width="142" height="50" alt="Yammer" /></div>
						...
						<div class="sponsor-small right"><img src="images/behance.png" width="80" height="35" alt="Behance" /></div>
			...
			<div id="location">
				...
				<div class="content">
					<ul class="main-nav">
						...
						<li><a href="#speakers" class="scroll">Speakers</a></li>
						<li><a href="#schedule" class="scroll">Schedule</a></li>
						<li><a class="selected scroll" href="#location">Location</a></li>
						<li><a href="#the-team" class="scroll">The Team</a></li>
					</ul><!-- end main-nav -->
			...
			<div id="the-team">
				...
				<div class="content">
					<ul class="main-nav">
						...
						<li><a href="#schedule" class="scroll">Schedule</a></li>
						<li><a href="#location" class="scroll">Location</a></li>
						<li><a class="selected scroll" href="#the-team">The Team</a></li>
					</ul><!-- end main-nav -->
				...
				<!-- right background circles -->
				<div class="blockquote-circle">
					<blockquote>One of the best ways to learn about Product Management from peers, and for product managers, 
